...
import { Grid, TextField, Button, Typography, Paper, Link, Checkbox, FormControlLabel } from '@material-ui/core';
        ...
        <Grid className="Login">
            <Paper elevation={3} className="login_paper">
                <Grid container alignItems="center" justifycontents="center" className="login_container" direction="column">
                    ...
                    <Button variant="outlined" onClick={loginAsTestProfessorCookie}>교수 계정 체험</Button>
                    <Button variant="outlined" onClick={loginAsTestStudentCookie}>학생 계정 체험</Button>
                </Grid>
            </Paper>
        </Grid>
    );
