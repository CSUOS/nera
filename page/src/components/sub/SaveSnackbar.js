            ...
            <Paper className="save_paper" elevation={4}>
                <Grid container direction="row" alignItems="center" justify="center">
                    <Grid item direction="column" alignItems="flex-start" justify="flex-end">
                        <Typography variant="caption" align="right" style={props.dateCaptionStyle} children={props.modifiedDateStr}></Typography>
                        <Typography variant="body2" align="right" style={props.statusStyle} children={props.status}></Typography>
                    </Grid>
